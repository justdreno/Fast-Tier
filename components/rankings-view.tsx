...
export default function RankingsView({ gameMode }: RankingsViewProps) {
  ...
  return (
    <main className="min-h-screen pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background to-secondary/10">
          ...
          {filteredPlayers.length > 0 ? (
            <div className="glass-morphism rounded-xl border border-white/10 overflow-hidden">
              ...
              <div className="grid grid-cols-12 gap-4 bg-secondary/30 px-6 py-4 border-b border-white/10">
                ...
                <div className="col-span-2 text-xs font-bold text-muted-foreground uppercase">W/L Ratio</div>
              </div>
              ...
              <div className="divide-y divide-white/5">
                {filteredPlayers.map((player, index) => (
                  <div
                    ...
                    className="fade-in-up grid grid-cols-12 gap-4 px-6 py-4 hover:bg-secondary/20 transition-colors"
                  >
