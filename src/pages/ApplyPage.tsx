      ...
      <div className="min-h-screen bg-[#0a0a0a] pb-12">
        ...
        <div className="pt-24 flex items-center justify-center min-h-[80vh]">
          <div className="container mx-auto px-4 max-w-2xl">
            <div className="bg-gradient-to-b from-[#141414] to-[#0f0f0f] border border-white/[0.08] rounded-3xl p-8 sm:p-12 shadow-2xl shadow-black/50 text-center animate-fade-in-up">
