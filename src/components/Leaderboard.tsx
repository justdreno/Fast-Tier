...
const tierColors = [
  ...
  { bg: 'from-[#3b82f6]/20 to-[#2563eb]/10', border: 'border-[#3b82f6]/30', text: 'text-[#3b82f6]', icon: '/tiers/tier_3.svg' },
  { bg: 'from-[#64748b]/20 to-[#475569]/10', border: 'border-[#64748b]/30', text: 'text-[#64748b]', icon: '/tiers/tier_3.svg' },
];
...
const groupPlayersByTier = (players: Player[], gamemode: string) => {
  ...
  players.forEach(player => {
    const relevantTiers = gamemode === 'overall' 
      ? player.tiers 
      : player.tiers?.filter(t => t.gamemode?.code === gamemode);
