        ...
        <div className="flex items-center justify-between h-14 px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            <Link to="/" className="flex items-center gap-1.5 hover:opacity-80 transition-opacity">
              <img src="/horizontal_logo.png" alt="FastTier" className="h-6 sm:h-7" />
            </Link>
          </div>

          {/* Right Side Actions */}
          <div className="flex items-center gap-2 sm:gap-3 p-1.5 bg-white/[0.02] border border-white/[0.05] rounded-[14px]">
            {/* Search Bar */}
