    ...
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-6xl">
      <nav className="bg-gradient-to-r from-[#09090d] to-[#0f0509] border border-white/[0.08] rounded-2xl shadow-2xl shadow-black/50 relative overflow-hidden">
        <div className="flex items-center justify-between h-16 px-4 sm:px-6">
          {/* Logo Area */}
          <div className="flex items-center bg-white/[0.03] border border-white/[0.08] rounded-xl px-3 py-1.5 shadow-lg shadow-black/20">
            <Link to="/" className="flex items-center hover:opacity-80 transition-opacity">
              <img src="/horizontal_logo.png" alt="FastTier" className="h-9 sm:h-11" />
            </Link>
          </div>

          {/* Right Side Actions Area */}
          <div className="flex items-center gap-2 sm:gap-3 bg-white/[0.03] border border-white/[0.08] rounded-xl px-3 py-1.5 shadow-lg shadow-black/20">
            {/* Search Bar */}
            ...
            <a
              ...
              className="flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white/60 hover:text-white hover:bg-white/[0.08] hover:border-white/20 transition-all duration-200"
            >
            ...
            {/* Apply Button */}
            <Link to="/apply" className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-[#ff9f43] hover:bg-[#ff9f43]/90 text-black font-bold text-sm rounded-lg transition-all duration-200 shadow-lg shadow-[#ff9f43]/10">
              Apply
            </Link>
            ...
            <button
              ...
              className="md:hidden flex items-center justify-center w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white/60 hover:text-white hover:bg-white/[0.08] transition-all duration-200"
            >
