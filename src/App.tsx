...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      {/* Banner Header */}
      <div 
        className="w-full h-64 sm:h-80 bg-cover bg-center bg-no-repeat relative"
        style={{
      ...
      <main className="container mx-auto px-3 sm:px-4 -mt-16 sm:-mt-20 pb-6 sm:pb-10 relative z-10">
